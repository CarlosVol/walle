...
__all__ = ["Minigame", "get_random_minigame", "set_maze_assets", "set_basura_assets", "set_memoria_assets", "set_recolector_assets", "set_cucaracha_assets", "get_minigame_by_name"]
